...
let handler = async (m, { conn }) => {
  ...
  const frasi = [
    ...
    `*Oh*! @${target.split("@")[0]} *ha rapito a*  @${sender.split("@")[0]} *e lo ha portato in un capanno lo ha legatoe iniziato a stuprare hard*  `,
  ...
  const testoFinale = `${fraseRandom}\n Stuprir icevuti da @${target.split("@")[0]}: ${globalThis.abbracciRank[target]}`;
