// 👑 UTENTI PROTETTI (non possono essere mutati)
...
const handler = async (msg, { conn, command, text, isAdmin }) => {
  ...
  // 👑 Protezione owner gruppo
  if (mentionedJid === groupOwner)
    throw '╭━━━👑━━━╮\n 𝐏𝐑𝐎𝐓𝐄𝐓𝐓𝐎\n╰━━━👑━━━╯\n\n𝐈𝐥 𝐜𝐫𝐞𝐚𝐭𝐨𝐫𝐞 𝐝𝐞𝐥 𝐠𝐫𝐮𝐩𝐩𝐨 𝐧𝐨𝐧 𝐩𝐮𝐨̀ 𝐞𝐬𝐬𝐞𝐫𝐞 𝐦𝐮𝐭𝐚𝐭𝐨.';

  // 👑 Protezione utenti specifici
  if (PROTECTED_USERS.includes(mentionedJid))
    throw '╭━━━👑━━━╮\n 𝐔𝐓𝐄𝐍𝐓𝐄 𝐏𝐑𝐎𝐓𝐄𝐓𝐓𝐎\n╰━━━👑━━━╯\n\n🚫 𝐐𝐮𝐞𝐬𝐭𝐨 𝐮𝐭𝐞𝐧𝐭𝐞 𝐧𝐨𝐧 𝐩𝐮𝐨̀ 𝐞𝐬𝐬𝐞𝐫𝐞 𝐦𝐮𝐭𝐚𝐭𝐨.';
